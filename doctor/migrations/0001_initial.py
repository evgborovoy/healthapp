    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_appointment_date', models.CharField(blank=True, max_length=90, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('NEW', 'New appointment'), ('CANCEL', 'Cancel appointment')], max_length=20)),
